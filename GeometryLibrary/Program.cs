...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Площадь треугольника со сторонами {a}, {b}, {c} = {triangle.CalculateArea()}");
        
        Console.WriteLine($"Треугольник с сторонами {a}, {b}, {c} является прямоугольным: {triangle.IsRightAngled()}");
        ...
        Console.WriteLine($"Площадь круга с радиусом 10 = {ShapeAreaCalculator.CalculateArea(shape1)}");
        Console.WriteLine(
